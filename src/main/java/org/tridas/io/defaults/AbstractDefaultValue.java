...
public abstract class AbstractDefaultValue<E extends Object> implements Cloneable {
	...
	/**
	 * @param argMaxLength
	 *            maximum length of returned string. -1 disables
	 * @param argMinLength
	 *            minimum length of returned string. -1 disables
	 */
	 ...
	 *         it's being overridden (see {@link #setOverridingValue(Object)} and
	 *         {@link #setOverriding(boolean)}).
	 */
