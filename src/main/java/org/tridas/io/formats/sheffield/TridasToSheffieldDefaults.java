...
public class TridasToSheffieldDefaults extends TridasMetadataFieldSet implements IMetadataFieldSet {
	...
	public void initDefaultValues() {
		...
		setDefaultValue(DefaultFields.DATA_TYPE, new GenericDefaultValue<SheffieldDataType>(
				SheffieldDataType.ANNUAL_RAW_RING_WIDTH));
		...
		setDefaultValue(DefaultFields.EDGE_CODE, new GenericDefaultValue<SheffieldEdgeCode>(
				SheffieldEdgeCode.NO_SPECFIC_EDGE));
		setDefaultValue(DefaultFields.CHRONOLOGY_TYPE, new GenericDefaultValue<SheffieldChronologyType>(
				SheffieldChronologyType.RAW));
		...
		setDefaultValue(DefaultFields.SHAPE_CODE, new GenericDefaultValue<SheffieldShapeCode>(
				SheffieldShapeCode.UNKNOWN));
		...
		setDefaultValue(DefaultFields.VARIABLE_TYPE, new GenericDefaultValue<SheffieldVariableCode>(
				SheffieldVariableCode.RING_WIDTHS));
	}
