...
public class CSVMatrixRemarksWriter extends AbstractDendroCollectionWriter {

	private TridasToMatrixDefaults defaults;
	private INamingConvention naming = new NumericalNamingConvention();
	protected Class<? extends CSVMatrixRemarksFile> clazz;
	...
	public CSVMatrixRemarksWriter() {
		super(TridasToMatrixDefaults.class, new CSVMatrixRemarksFormat());
		clazz = CSVMatrixRemarksFile.class;
	}
	
	
	public CSVMatrixRemarksWriter(Class<? extends IMetadataFieldSet> argDefaultFieldsClass, AbstractDendroFormat format) {
	...
	private void parseSeries(ITridasSeries series, CSVMatrixRemarksFile file)
	{
	...
	protected void parseTridasProject(TridasProject argProject,
		...
		CSVMatrixRemarksFile file = null;	
		try {
