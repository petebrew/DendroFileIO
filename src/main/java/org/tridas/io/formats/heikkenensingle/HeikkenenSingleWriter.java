...
public class HeikkenenSingleWriter extends AbstractDendroCollectionWriter {

	private TridasToHeikkenenSingleDefaults defaults;
	...
	protected void parseTridasProject(TridasProject argProject,
		...
		defaults = (TridasToHeikkenenSingleDefaults) argDefaults;
					...
					for (TridasRadius r : s.getRadiuses()) {											
						for (TridasMeasurementSeries ms : r.getMeasurementSeries()) {					
							for (int i = 0; i < ms.getValues().size(); i++) {
								...
								HeikkenenSingleFile file = new HeikkenenSingleFile(defaults);
