...
public class OriginalNamingConvention extends AbstractNamingConvention {
	...
	private String getDendroFilename(ITridasSeries argSeries) {
		...
		if (argSeries != null) {
			...
			if(argSeries.isSetGenericFields())
			{
				...
				{
					if(gf.getName().equals("originalFilename"))
					{
						return gf.getValue();
					}
				}
	...
	public String getDescription() {
		return I18n.getText("Maintain original filename where possible");
	}
	
	@Override
	public String getName() {
		return I18n.getText("Original filename");
	}
