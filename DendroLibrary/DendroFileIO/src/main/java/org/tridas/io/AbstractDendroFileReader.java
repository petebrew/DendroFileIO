...
public abstract class AbstractDendroFileReader {
	...
	/**
	 * @param argDefaultFieldsClass the default field set class used for metadata.
	 * @throws RuntimeException if argDefaultFieldsClass is null or doesn't have an empty constructor
	 */
	...
	/**
	 * Load a file from the given filename or url, and the given defaults.  Override this method
	 * and {@link #loadFile(String, String, IMetadataFieldSet)} to load files that aren't strings.
	 * @param argFilename
