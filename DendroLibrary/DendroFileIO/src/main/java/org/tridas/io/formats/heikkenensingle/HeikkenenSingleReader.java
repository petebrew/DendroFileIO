...
public class HeikkenenSingleReader extends AbstractDendroFileReader {

	private static final Logger log = LoggerFactory.getLogger(HeikkenenSingleReader.class);
	private HeikkenenSingleToTridasDefaults defaults = null;
	...
	protected void parseFile(String[] argFileString,
		...
		defaults = (HeikkenenSingleToTridasDefaults) argDefaultFields;
	...
	/**
	 * Check that the file contains just one integer on each line
	 * 
	 * @param argFileString
	 * @throws InvalidDendroFileException
	 */
